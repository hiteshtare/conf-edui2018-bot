...
const xml: any = CheerioLoad(file);
...
function getEventNodes(s: string, t: string): any[] {
  var events: any[] = [];
  xml(s).each((idx: number, elem: any) => {
...
function writeEvent(events: Array<any>): SpeakerSession[] {
